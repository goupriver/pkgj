...
#define PKGI_COLOR_LIST_TITLE_ID PKGI_COLOR(0, 145, 60)
#define PKGI_COLOR_LIST_REGION PKGI_COLOR(255, 255, 255) 
...
#define PKGI_COLOR_LIST_CIRCLE_UNACTIVE PKGI_COLOR(113, 131, 140)
